...
namespace SpeakingInBits.Controllers
{
    ...
    public class VideoLessonsController : Controller
    {
        ...
        {
            return View(await _context.VideoLeesons.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var videoLesson = await _context.VideoLeesons
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var videoLesson = await _context.VideoLeesons.FindAsync(id);
            if (videoLesson == null)
            {
                return NotFound();
            }
        ...
        {
            var videoLesson = await _context.VideoLeesons.FindAsync(id);
            _context.VideoLeesons.Remove(videoLesson);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.VideoLeesons.Any(e => e.LessonId == id);
        }
    }
}
